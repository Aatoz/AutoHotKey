License: NO LICENSE
	I (Noah Graydon) retain all rights and do not permit distribution, reproduction, or derivative works. I soley grant GitHub the required rights according to their terms of service; namely, GitHub users may view and fork the code.
...
Credits (This links to an external website, web content is not rated or monitored)
	AutoHotkey
		...
		<a href="http://www.autohotkey.com/board/topic/88699-class-lv-colors-coloured-rowscells-in-gui-listviews/">Just Me: LV_Colors.ahk</a>
		<a href="http://www.autohotkey.com/board/topic/79963-class-guitabex-additional-features-for-tabtab2/">Just Me: GuiTabEx.ahx</a>
		...
		<a href="http://www.autohotkey.com/board/topic/16137-xpath-v3-read-and-write-xml-documents-with-xpath-syntax/">Polythene: xpath.ahk</a>
		<a href="http://www.autohotkey.com/board/topic/19990-windowpad-window-moving-tool/">Lexikos: WindowPad</a> (Certain functions, such as wp_IsResizeable() were copied and then modified for use in the code)
		<a href="https://github.com/hoppfrosch/WindowPadX">Hoppfrosch: WindowPadX</a> (Certain functions, such as wp_IsResizeable() were copied and then modified for use in the code)
		<a href="http://www.autohotkey.com/board/topic/69464-how-to-determine-a-window-is-in-which-monitor/#entry440355">Shinywong: GetMonitorIndexFromWindow()</a>
		...
		<a href="http://www.autohotkey.com/board/topic/94083-ahk-11-font-and-color-dialogs/">Maestrith: Dlg.ahk</a> (Specifically the color picker dlg)
		<a href="http://www.autohotkey.com/board/topic/90481-library-fnt-v05-preview-do-stuff-with-fonts/">Jballi: Fnt.ahk</a>

	Visual
		<a href="http://taytel.deviantart.com/">Taytel</a> for Orb icon set
